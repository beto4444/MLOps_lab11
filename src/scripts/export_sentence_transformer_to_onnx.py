...
def export_model_to_onnx(settings: Settings):
    ...
    base_model = AutoModel.from_pretrained(settings.local_sentence_transformer_dir)
    tokenizer = AutoTokenizer.from_pretrained(settings.local_sentence_transformer_dir)
